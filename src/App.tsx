        ...
        <div className="main-content">
          ...
          <div className="left-content">
            ...
            <div className="info-tab projects">
              ...
              <div className="lower-tab" id="projects-section">
                {projects.length != 0 ? projects.slice(0,3).map((item : Project) => <ProjectDisplay pageName={item.pageName} title={item.title} projImg={item.projImg} previewImg={item.previewImg} technologiesUsed={item.technologiesUsed} projLink={item.projLink} projDescription={item.projDescription} technologyList={item.technologyList} technologyDetails={item.technologyDetails} key={item.title}/>): <p>Loading...</p>}
              </div>
          ...
          <div className="right-content" id="right-content">
            ...
            <p>
              ...
              <p>Technologies<span className="profile-label"> 12</span></p>
            </p>
            ...
            <div>
              ...
              <img title="Go" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/go/go-original-wordmark.svg" height="50px" width="50px" />
              ...
              <img title="Tailwind CSS" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/tailwindcss/tailwindcss-original.svg" height="50px" width="50px"/>
            </div>

          ...
          <div className="left-content">
            ...
            <div className="info-tab projects">
              ...
              <div className="lower-tab" id="projects-section">
                {projects.length != 0 ? projects.slice(0,3).map((item : Project) => <ProjectDisplay pageName={item.pageName} title={item.title} projImg={item.projImg} previewImg={item.previewImg} technologiesUsed={item.technologiesUsed} projLink={item.projLink} technologyList={item.technologyList}/>): <p>Loading...</p>}
              </div>
